...
<b>Provenance.</b> QTOF runs acquired in SWATH/DIA (grid/window) mode, the 2-D <i>m/z</i> × scan structure the grid encoding targets. SCIEX TripleTOF 6600 SWATH from PRIDE (PXD071869 · PXD011326) and MassIVE (MSV000090684 · MSV000093587), plus a SCIEX ZenoTOF 7600 top-down MRM-HR run (MSV000095995). Each dataset names its accession; all are openly licensed public deposits.
